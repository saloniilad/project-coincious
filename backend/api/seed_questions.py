...
SUBTRACTION_QUESTIONS = [
    ...
    # hard-basic  (only ₹1, ₹2, ₹10, ₹20 — single subtraction, larger totals)
    ("hard-basic",  "₹20 − ₹10 = ?",   [5,8,10,12],      10,  "mcq", 10),
    ("hard-basic",  "₹20 − ₹20 = ?",   [0,1,2,5],        0,   "mcq", 0),
    ("hard-basic",  "₹20 − ₹1 = ?",    [17,18,19,20],    19,  "mcq", 19),
    ("hard-basic",  "₹20 − ₹2 = ?",    [16,17,18,19],    18,  "mcq", 18),
    ("hard-basic",  "₹10 − ₹1 = ?",    [7,8,9,10],       9,   "mcq", 9),
    ("hard-basic",  "₹10 − ₹2 = ?",    [6,7,8,9],        8,   "mcq", 8),
    ("hard-basic",  "₹20 − ₹10 = ?",   [8,9,10,11],      10,  "mcq", 10),
    ("hard-basic",  "₹10 − ₹10 = ?",   [0,1,2,5],        0,   "mcq", 0),
    ("hard-basic",  "₹20 − ₹10 = ?",   [6,8,10,12],      10,  "mcq", 10),
    ("hard-basic",  "₹10 − ₹1 = ?",    [6,7,8,9],        9,   "mcq", 9),
    # hard-moderate  (only ₹1, ₹2, ₹10, ₹20 — two subtractions)
    ("hard-moderate", "₹20 − ₹10 − ₹2 = ?",   [6,7,8,9],       8,   "mcq", 8),
    ("hard-moderate", "₹20 − ₹10 − ₹1 = ?",   [7,8,9,10],      9,   "mcq", 9),
    ("hard-moderate", "₹20 − ₹2 − ₹2 = ?",    [14,15,16,17],   16,  "mcq", 16),
    ("hard-moderate", "₹20 − ₹1 − ₹1 = ?",    [17,18,19,20],   18,  "mcq", 18),
    ("hard-moderate", "₹20 − ₹10 − ₹10 = ?",  [0,1,2,5],       0,   "mcq", 0),
    ("hard-moderate", "₹10 − ₹2 − ₹1 = ?",    [6,7,8,9],       7,   "mcq", 7),
    ("hard-moderate", "₹10 − ₹2 − ₹2 = ?",    [5,6,7,8],       6,   "mcq", 6),
    ("hard-moderate", "₹20 − ₹2 − ₹10 = ?",   [6,7,8,9],       8,   "mcq", 8),
    ("hard-moderate", "₹20 − ₹1 − ₹2 = ?",    [15,16,17,18],   17,  "mcq", 17),
    ("hard-moderate", "₹10 − ₹1 − ₹1 = ?",    [7,8,9,10],      8,   "mcq", 8),
    # hard-high  (only ₹1, ₹2, ₹10, ₹20 — three or mixed subtractions)
    ("hard-high",   "₹20 − ₹10 − ₹2 − ₹1 = ?",   [5,6,7,8],      7,   "mcq", 7),
    ("hard-high",   "₹20 − ₹2 − ₹2 − ₹2 = ?",    [12,13,14,15],  14,  "mcq", 14),
    ("hard-high",   "₹20 − ₹1 − ₹1 − ₹1 = ?",    [16,17,18,19],  17,  "mcq", 17),
    ("hard-high",   "₹20 − ₹10 − ₹1 − ₹1 = ?",   [7,8,9,10],     8,   "mcq", 8),
    ("hard-high",   "₹20 − ₹2 − ₹1 − ₹10 = ?",   [5,6,7,8],      7,   "mcq", 7),
    ("hard-high",   "₹10 − ₹2 − ₹2 − ₹1 = ?",    [4,5,6,7],      5,   "mcq", 5),
    ("hard-high",   "₹20 − ₹10 − ₹2 − ₹2 = ?",   [4,5,6,7],      6,   "mcq", 6),
    ("hard-high",   "₹20 − ₹1 − ₹2 − ₹10 = ?",   [5,6,7,8],      7,   "mcq", 7),
    ("hard-high",   "₹10 − ₹1 − ₹2 − ₹2 = ?",    [4,5,6,7],      5,   "mcq", 5),
    ("hard-high",   "₹20 − ₹2 − ₹2 − ₹1 − ₹1 = ?", [13,14,15,16], 14, "mcq", 14),
]
...
DIVISION_QUESTIONS = [
    # easy-basic
    ("easy-basic",  "₹10 ÷ 2 = ?",   [2,5,10,20],      5,   "mcq", 5),
    ("easy-basic",  "₹20 ÷ 2 = ?",   [5,10,20,2],      10,  "mcq", 10),
    ("easy-basic",  "₹20 ÷ 4 = ?",   [4,5,10,2],       5,   "mcq", 5),
    ("easy-basic",  "₹50 ÷ 5 = ?",   [5,10,20,25],     10,  "mcq", 10),
    ("easy-basic",  "₹10 ÷ 5 = ?",   [1,2,5,10],       2,   "mcq", 2),
    ("easy-basic",  "₹20 ÷ 5 = ?",   [2,4,5,10],       4,   "mcq", 4),
    ("easy-basic",  "₹50 ÷ 2 = ?",   [10,20,25,50],    25,  "mcq", 25),
    ("easy-basic",  "₹100 ÷ 5 = ?",  [10,20,25,50],    20,  "mcq", 20),
    ("easy-basic",  "₹100 ÷ 2 = ?",  [20,25,50,100],   50,  "mcq", 50),
    ("easy-basic",  "₹50 ÷ 10 = ?",  [2,5,10,20],      5,   "mcq", 5),
    # easy-moderate
    ("easy-moderate", "₹50 ÷ 2 = ?",    [10,20,25,50],   25,  "mcq", 25),
    ("easy-moderate", "₹100 ÷ 2 = ?",   [25,50,75,100],  50,  "mcq", 50),
    ("easy-moderate", "₹100 ÷ 4 = ?",   [20,25,50,10],   25,  "mcq", 25),
    ("easy-moderate", "₹50 ÷ 5 = ?",    [5,10,15,20],    10,  "mcq", 10),
    ("easy-moderate", "₹20 ÷ 2 = ?",    [5,10,20,15],    10,  "mcq", 10),
    ("easy-moderate", "₹100 ÷ 10 = ?",  [5,10,20,50],    10,  "mcq", 10),
    ("easy-moderate", "₹50 ÷ 10 = ?",   [2,5,10,20],     5,   "mcq", 5),
    ("easy-moderate", "₹20 ÷ 4 = ?",    [2,4,5,10],      5,   "mcq", 5),
    ("easy-moderate", "₹100 ÷ 5 = ?",   [10,20,25,50],   20,  "mcq", 20),
    ("easy-moderate", "₹50 ÷ 25 = ?",   [1,2,5,10],      2,   "mcq", 2),
    # easy-high
    ("easy-high",   "₹200 ÷ 2 = ?",   [50,100,200,20],  100, "mcq", 100),
    ("easy-high",   "₹200 ÷ 4 = ?",   [25,40,50,100],   50,  "mcq", 50),
    ("easy-high",   "₹200 ÷ 5 = ?",   [20,40,50,25],    40,  "mcq", 40),
    ("easy-high",   "₹200 ÷ 10 = ?",  [10,20,40,50],    20,  "mcq", 20),
    ("easy-high",   "₹100 ÷ 4 = ?",   [20,25,50,10],    25,  "mcq", 25),
    ("easy-high",   "₹100 ÷ 10 = ?",  [5,10,20,25],     10,  "mcq", 10),
    ("easy-high",   "₹200 ÷ 8 = ?",   [20,25,40,50],    25,  "mcq", 25),
    ("easy-high",   "₹100 ÷ 20 = ?",  [2,5,10,20],      5,   "mcq", 5),
    ("easy-high",   "₹200 ÷ 20 = ?",  [5,10,20,25],     10,  "mcq", 10),
    ("easy-high",   "₹50 ÷ 2 = ?",    [10,20,25,50],    25,  "mcq", 25),
    # medium-basic
    ("medium-basic", "₹100 ÷ 2 = ?",   [25,50,100,20],   50,  "mcq", 50),
    ("medium-basic", "₹200 ÷ 2 = ?",   [50,100,200,20],  100, "mcq", 100),
    ("medium-basic", "₹200 ÷ 4 = ?",   [25,40,50,100],   50,  "mcq", 50),
    ("medium-basic", "₹100 ÷ 5 = ?",   [10,20,25,50],    20,  "mcq", 20),
    ("medium-basic", "₹200 ÷ 5 = ?",   [20,40,50,100],   40,  "mcq", 40),
    ("medium-basic", "₹100 ÷ 10 = ?",  [5,10,20,25],     10,  "mcq", 10),
    ("medium-basic", "₹200 ÷ 10 = ?",  [10,20,40,50],    20,  "mcq", 20),
    ("medium-basic", "₹50 ÷ 2 = ?",    [10,20,25,50],    25,  "mcq", 25),
    ("medium-basic", "₹200 ÷ 20 = ?",  [5,10,20,25],     10,  "mcq", 10),
    ("medium-basic", "₹100 ÷ 4 = ?",   [20,25,50,10],    25,  "mcq", 25),
    # medium-moderate
    ("medium-moderate", "₹200 ÷ 8 = ?",   [10,20,25,40],  25,  "mcq", 25),
    ("medium-moderate", "₹100 ÷ 25 = ?",  [2,4,5,10],     4,   "mcq", 4),
    ("medium-moderate", "₹200 ÷ 25 = ?",  [4,5,8,10],     8,   "mcq", 8),
    ("medium-moderate", "₹200 ÷ 50 = ?",  [2,4,5,10],     4,   "mcq", 4),
    ("medium-moderate", "₹100 ÷ 20 = ?",  [2,5,10,20],    5,   "mcq", 5),
    ("medium-moderate", "₹50 ÷ 5 = ?",    [5,10,15,20],   10,  "mcq", 10),
    ("medium-moderate", "₹200 ÷ 20 = ?",  [5,10,20,25],   10,  "mcq", 10),
    ("medium-moderate", "₹100 ÷ 5 = ?",   [10,20,25,50],  20,  "mcq", 20),
    ("medium-moderate", "₹50 ÷ 10 = ?",   [2,5,10,20],    5,   "mcq", 5),
    ("medium-moderate", "₹200 ÷ 10 = ?",  [10,20,40,50],  20,  "mcq", 20),
    # medium-high
    ("medium-high", "₹100 ÷ 4 = ?",   [10,20,25,50],   25,  "mcq", 25),
    ("medium-high", "₹200 ÷ 8 = ?",   [20,25,40,50],   25,  "mcq", 25),
    ("medium-high", "₹100 ÷ 5 = ?",   [10,20,25,50],   20,  "mcq", 20),
    ("medium-high", "₹200 ÷ 10 = ?",  [10,20,40,50],   20,  "mcq", 20),
    ("medium-high", "₹100 ÷ 20 = ?",  [2,5,10,20],     5,   "mcq", 5),
    ("medium-high", "₹200 ÷ 5 = ?",   [20,40,50,100],  40,  "mcq", 40),
    ("medium-high", "₹200 ÷ 4 = ?",   [25,40,50,100],  50,  "mcq", 50),
    ("medium-high", "₹200 ÷ 20 = ?",  [5,10,20,25],    10,  "mcq", 10),
    ("medium-high", "₹50 ÷ 5 = ?",    [5,10,20,25],    10,  "mcq", 10),
    ("medium-high", "₹20 ÷ 4 = ?",    [2,4,5,10],      5,   "mcq", 5),
    # hard-basic
    ("hard-basic", "(₹100 + ₹100) ÷ 2 = ?",       [50,100,150,200],   100, "mcq", 100),
    ("hard-basic", "(₹50 + ₹50) ÷ 2 = ?",         [25,50,75,100],     50,  "mcq", 50),
    ("hard-basic", "(₹100 + ₹50) ÷ 5 = ?",        [20,30,40,50],      30,  "mcq", 30),
    ("hard-basic", "(₹200 + ₹200) ÷ 4 = ?",       [50,100,150,200],   100, "mcq", 100),
    ("hard-basic", "(₹100 + ₹20) ÷ 2 = ?",        [40,50,60,70],      60,  "mcq", 60),
    ("hard-basic", "(₹50 + ₹20) ÷ 7 = ?",         [5,10,15,20],       10,  "mcq", 10),
    ("hard-basic", "(₹100 + ₹100) ÷ 4 = ?",       [25,50,75,100],     50,  "mcq", 50),
    ("hard-basic", "(₹50 + ₹50) ÷ 5 = ?",         [10,20,30,40],      20,  "mcq", 20),
    ("hard-basic", "(₹200 + ₹100) ÷ 5 = ?",       [40,50,60,70],      60,  "mcq", 60),
    ("hard-basic", "(₹100 + ₹100) ÷ 10 = ?",      [10,20,30,40],      20,  "mcq", 20),
    # hard-moderate
    ("hard-moderate", "(₹100 + ₹100 + ₹50) ÷ 5 = ?",        [40,50,60,70],   50,  "mcq", 50),
    ("hard-moderate", "(₹200 + ₹50 + ₹50) ÷ 5 = ?",         [40,50,60,70],   60,  "mcq", 60),
    ("hard-moderate", "(₹100 + ₹20 + ₹20) ÷ 4 = ?",         [25,30,35,40],   35,  "mcq", 35),
    ("hard-moderate", "(₹200 + ₹100 + ₹50) ÷ 7 = ?",        [40,50,60,70],   50,  "mcq", 50),
    ("hard-moderate", "(₹50 + ₹50 + ₹20) ÷ 4 = ?",          [20,25,30,35],   30,  "mcq", 30),
    ("hard-moderate", "(₹200 + ₹200 + ₹100) ÷ 10 = ?",      [40,50,60,70],   50,  "mcq", 50),
    ("hard-moderate", "(₹100 + ₹50 + ₹20) ÷ 3 = ?",         [50,55,60,65],   60,  "mcq", 60),
    ("hard-moderate", "(₹200 + ₹100 + ₹20) ÷ 4 = ?",        [70,75,80,85],   80,  "mcq", 80),
    ("hard-moderate", "(₹50 + ₹50 + ₹50) ÷ 3 = ?",          [40,45,50,55],   50,  "mcq", 50),
    ("hard-moderate", "(₹200 + ₹50 + ₹20) ÷ 3 = ?",         [80,85,90,95],   90,  "mcq", 90),
    # hard-high
    ("hard-high", "₹200 ÷ 4 + ₹100 ÷ 2 = ?",     [80,90,100,110],  100, "mcq", 100),
    ("hard-high", "₹100 ÷ 4 + ₹200 ÷ 5 = ?",     [55,60,65,70],    65,  "mcq", 65),
    ("hard-high", "₹200 ÷ 10 + ₹50 ÷ 5 = ?",     [20,25,30,35],    30,  "mcq", 30),
    ("hard-high", "₹100 ÷ 5 + ₹200 ÷ 4 = ?",     [60,70,75,80],    70,  "mcq", 70),
    ("hard-high", "₹200 ÷ 8 + ₹100 ÷ 5 = ?",     [35,40,45,50],    45,  "mcq", 45),
    ("hard-high", "₹100 ÷ 2 + ₹200 ÷ 10 = ?",    [60,70,80,90],    70,  "mcq", 70),
    ("hard-high", "₹200 ÷ 5 + ₹100 ÷ 4 = ?",     [60,65,70,75],    65,  "mcq", 65),
    ("hard-high", "₹100 ÷ 10 + ₹200 ÷ 4 = ?",    [55,60,65,70],    60,  "mcq", 60),
    ("hard-high", "₹200 ÷ 20 + ₹100 ÷ 2 = ?",    [50,55,60,65],    60,  "mcq", 60),
    ("hard-high", "₹100 ÷ 5 + ₹50 ÷ 2 = ?",      [35,40,45,50],    45,  "mcq", 45),
]
...
WORD_PROBLEM_QUESTIONS = [
    ...
    ("easy-basic",    "Buy 1 lollipop. Price ₹2. How much do you pay?",         "Lollipop",     2),
    ("easy-basic",    "Buy 1 orange. Price ₹10. How much do you pay?",          "Orange",       10),
    # easy-moderate
    ...
    ("easy-moderate", "Buy 5 lollipops. Price ₹2 each. How much do you pay?",   "Lollipop",     10),
    ("easy-moderate", "Buy 4 erasers. Price ₹5 each. How much do you pay?",     "Eraser",       20),
    ...
    ("easy-high",  "Buy 1 story book. Price ₹100. How much do you pay?",  "Story Book",  100),
    ("easy-high",     "Buy 2 toy balls. Price ₹20 each. How much do you pay?",  "Toy Ball",     40),
    ("easy-high",     "Buy 4 chocolates. Price ₹20 each. How much do you pay?", "Chocolate",    80),
    # medium-basic
    ("medium-basic",  "Buy 1 toy. Price ₹200. How much do you pay?",            "Toy",          200),
    ("medium-basic",  "Buy 1 school bag. Price ₹300. How much do you pay?",     "School Bag",   300),
    ("medium-basic",  "Buy 2 notebooks. Price ₹50 each. How much do you pay?",  "Notebook",     100),
    ("medium-basic",  "Buy 1 water bottle. Price ₹150. How much do you pay?",   "Water Bottle", 150),
    ("medium-basic",  "Buy 1 lunch box. Price ₹200. How much do you pay?",      "Lunch Box",    200),
    ...
    ("medium-basic",  "Buy 2 toy balls. Price ₹80 each. How much do you pay?",  "Toy Ball",     160),
    ("medium-basic",  "Buy 1 t-shirt. Price ₹250. How much do you pay?",        "T-Shirt",      250),
    ...
    ("medium-moderate","Buy 2 toys. Price ₹200 each. How much do you pay?",     "Toy",          400),
    ("medium-moderate","Buy 3 ice-creams. Price ₹50 each. How much do you pay?","Ice Cream",    150),
    ("medium-moderate","Buy 4 notebooks. Price ₹50 each. How much do you pay?", "Notebook",     200),
    ...
    ("medium-high",   "Buy 4 toys. Price ₹200 each. How much do you pay?",      "Toy",          800),
    ...
    ("medium-high",   "Buy 5 toys. Price ₹100 each. How much do you pay?",      "Toy",          500),
    ("medium-high",   "Buy 9 balloons. Price ₹20 each. How much do you pay?",   "Balloon",      180),
    ("medium-high",   "Buy 4 school bags. Price ₹300 each. How much do you pay?","School Bag",  1200),
    # hard-basic
    ("hard-basic",    "Buy 1 toy. Price ₹500. How much do you pay?",            "Toy",          500),
    ("hard-basic",    "Buy 1 cricket bat. Price ₹800. How much do you pay?",    "Cricket Bat",  800),
    ...
    ("hard-basic",    "Buy 1 headphones. Price ₹1000. How much do you pay?",    "Headphone",    1000),
    ("hard-basic",    "Buy 1 board game. Price ₹700. How much do you pay?",     "Board Game",   700),
    ("hard-basic",    "Buy 2 toys. Price ₹300 each. How much do you pay?",      "Toy",          600),
    ("hard-basic",    "Buy 1 shoe. Price ₹900. How much do you pay?",           "Shoe",         900),
    ("hard-basic",    "Buy 2 cricket balls. Price ₹250 each. How much do you pay?","Cricket Ball",500),
    ("hard-basic",    "Buy 1 jacket. Price ₹1200. How much do you pay?",        "Jacket",       1200),
    # hard-moderate
    ...
    ("hard-moderate", "Buy 3 toys. Price ₹200 each. How much do you pay?",      "Toy",          600),
    ("hard-moderate", "Buy 6 notebooks. Price ₹80 each. How much do you pay?",  "Notebook",     480),
    ("hard-moderate", "Buy 4 school bags. Price ₹300 each. How much do you pay?","School Bag",  1200),
    ("hard-moderate", "Buy 5 toy cars. Price ₹150 each. How much do you pay?",  "Toy Car",      750),
    ("hard-moderate", "Buy 3 board games. Price ₹700 each. How much do you pay?","Board Game",  2100),
    ("hard-moderate", "Buy 4 jackets. Price ₹1200 each. How much do you pay?",  "Jacket",       4800),
    ("hard-moderate", "Buy 6 shoes. Price ₹900 each. How much do you pay?",     "Shoe",         5400),
    ("hard-moderate", "Buy 5 headphones. Price ₹1000 each. How much do you pay?","Headphone",   5000),
    # hard-high
    ...
    ("hard-high",     "Buy 8 notebooks. Price ₹80 each. How much do you pay?",  "Notebook",     640),
    ("hard-high",     "Buy 7 toys. Price ₹200 each. How much do you pay?",      "Toy",          1400),
    ...
    ("hard-high",     "Buy 6 school bags. Price ₹300 each. How much do you pay?","School Bag",  1800),
    ("hard-high",     "Buy 5 board games. Price ₹700 each. How much do you pay?","Board Game",  3500),
    ("hard-high",     "Buy 4 headphones. Price ₹1000 each. How much do you pay?","Headphone",   4000),
]
